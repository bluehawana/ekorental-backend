        ...
        return args -> {
            ...
            Arrays.asList(
                    createOrUpdateCar(carRepository, Car.builder()
                            ...
                            .imageUrl("http://localhost:8085/uploads/model_3.png")
                            .isAvailable(true)
                    ...
                    createOrUpdateCar(carRepository, Car.builder()
                            ...
                            .imageUrl("http://localhost:8085/uploads/model_y.png")
                            .isAvailable(true)
                    ...
                    createOrUpdateCar(carRepository, Car.builder()
                            ...
                            .imageUrl("http://localhost:8085/uploads/model_s.png")
                            .isAvailable(true)
                            .location("Lindholmen Science Park")
                            .year(2024)
                    ...
                    createOrUpdateCar(carRepository, Car.builder()
                            ...
                            .imageUrl("http://localhost:8085/uploads/model_x.png")
                            .isAvailable(true)
                    ...
                    createOrUpdateCar(carRepository, Car.builder()
                            ...
                            .imageUrl("http://localhost:8085/uploads/cybertruck.png")
                            .isAvailable(true)
                            .location("Chalmers University")
                            .year(2024)
                    ...
                    createOrUpdateCar(carRepository, Car.builder()
                            ...
                            .imageUrl("http://localhost:8085/uploads/roadster.png")
                            .isAvailable(true)
                            .location("Nordstan Park")
                            .year(2024)
